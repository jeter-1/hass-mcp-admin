...
| `get_error_log` | Redesign | Tail raw HA error log. | Unstructured text, no severity/search/source classification, and possible sensitive content. | Replace with structured diagnostic extraction plus redaction and correlation. |
