...
| `get_error_log` | Transitional | Return bounded structured HA System Log warning/error entries. | The System Log buffer is deduplicated and is not the complete raw Core journal. | Keep redaction, truncation, source attribution, and correlation mandatory. |
