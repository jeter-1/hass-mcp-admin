"""Verify exact ha-mcp 8.2.0 vendoring and Home Assistant isolation contracts."""
...
EXPECTED_SOURCE_COMMIT = "54c492510d05b1f33c777f1c94bfb6a50a7d7c42"
...
def verify_source(source_root: Path) -> dict[str, object]:
    ...
    return {
        "result": "PASS",
        "model": "ha-mcp-8.2.0-vendored-websockets-isolation-v1",
