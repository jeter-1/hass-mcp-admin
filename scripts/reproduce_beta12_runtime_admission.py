...
def markdown(report: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "raw full-descriptor runtime comparator differs. The version-scoped v2 "
            "model validates the policy block's exact fields, JSON types, deployment "
            "allowlist, and rule-count bound before normalizing only its dynamic "
            "values. Every other descriptor field remains exact, and the strict raw "
