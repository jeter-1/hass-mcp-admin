...
`2.2.0-beta.5` adds an inert update-and-recovery preflight evaluator while
preserving the K1 knowledge-provenance, C1 signed-registry, and durable
...
version `2.2.0-beta.5` retains governed controlled reload, exact add-on restart,
Home Assistant restart, readback-only reconciliation, and one durable execution
task for each newly executed plan. Its update/recovery preflight,
...
[`../docs/V2_2_0_BETA5_ACCEPTANCE.md`](../docs/V2_2_0_BETA5_ACCEPTANCE.md), and
