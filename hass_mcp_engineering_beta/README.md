...
6. Leave `dependency_index_prewarm` disabled unless you intentionally want one
   background, connectivity-gated cold index build after startup.
...
`2.0.0-rc2-dev4` after release approval, the expected complete release
