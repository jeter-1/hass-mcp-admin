...
CAPABILITY_PROVIDER_MATRIX: tuple[dict[str, Any], ...] = (
    {
        ...
        "security_justification": "A fixed read-only upstream MCP allowlist exposes dashboard identity metadata without service calls, writes, or arbitrary tool forwarding.",
    },
    {
        "tool": "get_dashboard_config",
        ...
        "fallback_policy": "none",
        "security_justification": "A fixed read-only upstream MCP operation returns sanitized dashboard evidence and cannot invoke dashboard mutation or Home Assistant services.",
    },
    {
        "tool": "handoff_generation",
