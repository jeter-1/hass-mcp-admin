...
CAPABILITY_PROVIDER_MATRIX: tuple[dict[str, Any], ...] = (
    {
        ...
        "security_justification": "A reviewed, version-pinned, argument-constrained upstream operation can construct only list_only=true with include_screenshot=false; the mixed upstream tool is not treated as globally read-only.",
        "trust_mode": "reviewed_argument_constrained",
        "trust_profile": "ha_mcp_7_13_dashboard_read_v1",
    },
    {
        ...
        "fallback_policy": "none",
        "security_justification": "A reviewed, version-pinned, argument-constrained upstream operation can construct only an exact URL-path read with include_screenshot=false; rendering, preferences, mutation, and service calls remain unreachable.",
        "trust_mode": "reviewed_argument_constrained",
        "trust_profile": "ha_mcp_7_13_dashboard_read_v1",
    },
    {
