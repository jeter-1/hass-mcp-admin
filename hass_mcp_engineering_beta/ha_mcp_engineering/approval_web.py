...
def _bounded_dashboard_review(
    ...
    """Validate the complete persisted dashboard projection before rendering."""
...
def _render_complete_dashboard_projection(
    ...
    """Render complete inert JSON values for every declared dashboard patch."""
...
def _render_review(prefix: str, review: dict[str, Any], csrf: str) -> str:
    ...
    projection_error = (
        operation_projection_error or dashboard_projection_error
    )
    rows = [
        ...
        row(
            ...
            (
                ...
                if has_operation_projection and not operation_projection_error
                    ...
                    if has_dashboard_projection
                    and not dashboard_projection_error
                    else (
