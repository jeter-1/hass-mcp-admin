...
> add-on is developed in place at `2.2.0-beta.9`, based on the exact
> `v2.0.1` release, at
...
> The current Engineering development version is `2.2.0-beta.9`. Its corrected
> real Beta 6 prohibited-plan compatibility boundary is recorded in
> [`docs/V2_2_0_BETA9_RELEASE_NOTES.md`](docs/V2_2_0_BETA9_RELEASE_NOTES.md)
> and [`docs/V2_2_0_BETA9_ACCEPTANCE.md`](docs/V2_2_0_BETA9_ACCEPTANCE.md).
...
The current Engineering development version is `2.2.0-beta.9`, based on the
accepted Beta 6 F2 foundation and Beta 7 evidence corrections. It restores
read compatibility for the real contract-v2 prohibited/superseded records
written by Beta 6, contains individual projection failures, and reconciles
health accounting without adding a resource type, provider, tool, arbitrary
service call, approval mode, or fallback.
The roadmap and acceptance authority are
[`docs/2_1_ROADMAP.md`](docs/2_1_ROADMAP.md) and
[`docs/V2_2_0_BETA9_ACCEPTANCE.md`](docs/V2_2_0_BETA9_ACCEPTANCE.md). Determine advertised
