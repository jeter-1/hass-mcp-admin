...
`2.0.0-rc2-dev5`, based on the verified RC2dev4 release commit. It has 40 registered
...
protocol, annotations, complete input schema, and the reviewed security
contract are pinned; the complete runtime descriptor remains drift evidence.
