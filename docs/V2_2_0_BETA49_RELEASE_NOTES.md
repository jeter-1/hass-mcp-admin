...
lowercase ASCII Home Assistant domain of at most 64 characters, with no leading,
trailing or consecutive underscores and at least one ASCII letter; malformed
values are not normalized. The supported Home Assistant 2026.7.2, 2026.8.0 and
2026.8.1 lanes use the same underlying domain grammar. Missing source/state
evidence, cycles, partial or malformed membership, overflow, dynamic selectors
and unknown entity-producing callables remain conservative. A scalar result
