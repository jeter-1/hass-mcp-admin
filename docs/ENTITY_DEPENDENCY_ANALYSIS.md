...
The server-side Beta 11 manifest contains 33 tools. Recreate the ChatGPT beta connector or
use the cache marker `?manifest=beta11` if the tool is absent. Never place a real secret
