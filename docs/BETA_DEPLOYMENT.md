...
The active Beta 8 source and later operator-controlled acceptance boundary is
[`V2_2_0_BETA8_ACCEPTANCE.md`](V2_2_0_BETA8_ACCEPTANCE.md). It requires
read-only compatibility for validated Beta 6 prohibited plans and retains the
Beta 7 truthful provider-response contract before any separately authorized
