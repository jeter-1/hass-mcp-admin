...
class PolicyInventoryTests(unittest.TestCase):
    ...
    def test_engineering_catalog_is_45_without_upstream_discovery(self):
        self.assertEqual(len(registered_tools(get_registered_server()).values()), 45)
...
class RegistrationTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_catalog_and_capability_counts_are_truthful(self):
        ...
        self.assertEqual(catalog["engineering_registered_count"], 45)
