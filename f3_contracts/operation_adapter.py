"""Declaration-only F3 operation-adapter contract.

F3-0 freezes names and type shapes for later implementation branches.  The
current runtime deliberately does not import or package this module and no
persisted record is serialized from these declarations.
"""
...
class OperationAdapter(Protocol[ProposalT, PreparedT]):
    """Stable interface later F3 adapters implement without widening authority."""
